...
<head>
    ...
    <meta name="dicoding:f1216xb135@dicoding.org" content="daradona029@gmail.com">
                    ...
                    <div class="col-lg-10">
                        <form action="{{ route('searchBeasiswa') }}" method="GET">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Cari beasiswa..." name="q"
                                    value="{{ request('q') }}">
                        ...
                        <div class="col-lg-6 mb-2">
                            <div class="icon-box d-flex align-items-center p-3 shadow-sm rounded bg-white"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span
                                        class="badge rounded-pill bg-warning text-dark mb-2">{{ $item->kategori }}</span>
